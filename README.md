...
|---------------|--------------|-------------------------------------------------------------------------------------|
| 🚧 Planning    | Week 1       | 🔹 Define feature set <br> 🔹 Research APIs and libraries <br> 🔹 App structure design |
| 🛠 Development | Week 2–4     | 🔹 Implement core video module <br> 🔹 Add chat system <br> 🔹 Integrate AI moderation |
| 🎨 UI Polish   | Week 5       | 🔹 Refine styling with Tailwind <br> 🔹 Add responsiveness and animations             |
